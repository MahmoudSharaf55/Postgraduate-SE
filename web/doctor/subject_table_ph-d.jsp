    ...
    <table class="table" style="overflow-y:scroll; height:100%;">
        ...
        <%
            ...
            try {
                ...
                PreparedStatement statement = c.prepareStatement("select s.id, s.username, s.email, f.status, f.paper from student as s inner join student_form as f where paper!='In Reviewing' AND form_type=1  and s.id=f.s_id and doctor_mail=?");
