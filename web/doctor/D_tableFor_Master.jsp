...
<form method="post" class="table-form"  style="overflow-y:scroll; height:100%; overflow-x: scroll; width:100%;" >
    <div class="titalForsertification">
        ...
        %>
        <h3 class="text-center" > Data For All Student That Register In Magestar For Year <%=lastYear%>/<%=currentYear%>   Department / <%=department%> </h3>
    </div>
    <table  class="table" style="overflow-y:scroll; height:100%; overflow-x: scroll; width:100%;" >
        ...
        <%
            ...
            try
            {
                ...
                PreparedStatement preparedStatement=c.prepareStatement("select s_id, name, dob, job,b_graduate_source, recruitment_postion, bachelor_in, b_overall_rate, b_overall_mark, b_graduate_year  from student_form   where  paper !='In Reviewing' and status='Waiting' and form_type=3  ;");
