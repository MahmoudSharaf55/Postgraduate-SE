            ...
            <div id="myTabContent" class="tab-content p-3">
                <div class="tab-pane fade active show" id="personal-info">
                    <div class="form-group">
                        ...
                        <input id="depart" type="text" class="form-control bg-light" required name="dept"
                    ...
                    <div class="form-group">
                        ...
                        <input id="round" type="text" class="form-control bg-light" required name="round"
                ...
                <div class="tab-pane fade" id="family-Info">
                    <div class="form-group">
                        ...
                        <input id="full-name" type="text" class="form-control bg-light" required name="name"
                    ...
                    <div class="row">
                        <div class="form-group col-md-3">
                            ...
                            <input id="dob" type="date" class="form-control bg-light" required name="dob"
                    ...
                    <div class="form-group">
                        ...
                        <input id="army" type="text" class="form-control bg-light" required name="army"
                ...
                <div class="tab-pane fade" id="faculty-info">
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input id="master" type="text" class="form-control bg-light" required name="m_in"
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input id="m-Role" type="text" class="form-control bg-light" required name="m_role"
                                   placeholder="Role" data-toggle="tooltip" data-placement="bottom"
                                   title="دور">
                            <div class="invalid-feedback">
                                <b>&Cross; Empty Field</b>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            <label for="m-sp">Specialization</label>
                            <input id="m-sp" type="text" class="form-control bg-light" required name="m_sp_rate"
                                   placeholder="Specialization Rate" data-toggle="tooltip" data-placement="bottom"
                                   title="التخصص">
                            <div class="invalid-feedback">
                                <b>&Cross; Empty Field</b>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input id="d-gpa" type="text" class="form-control bg-light" required name="m_rate"
                                   placeholder="Overall Rate" data-toggle="tooltip" data-placement="bottom"
                                   title="بتقدير">
                            <div class="invalid-feedback">
                                <b>&Cross; Empty Field</b>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input id="m-mark" type="number" class="form-control bg-light" required name="m_mark"
                                   placeholder="Overall Mark" data-toggle="tooltip" data-placement="bottom"
                                   title="المجموع التراكمى">
                            <div class="invalid-feedback">
                                <b>&Cross; Empty Field</b>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input id="d-University" type="text" class="form-control bg-light" required name="m_src"
