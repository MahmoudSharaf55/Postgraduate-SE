    ...
    <table class="table" style="overflow-y:scroll; height:100%;">
        ...
        <% request.setCharacterEncoding("UTF-8");
            try {
                ...
                ResultSet resultSet = statement.executeQuery("select s.id, s.username, s.email, f.status, f.paper , f.doctor_mail from student as s inner join student_form as f where f.status!='Waiting' and f.paper!='In Reviewing' AND f.doctor_mail='Waiting' AND  form_type=1 and  s.id=f.s_id ;");
